...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 via-blue-50/50 to-purple-50/30">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Полный спектр услуг по изготовлению и установке памятников от ведущих мастеров с многолетним опытом
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="group relative overflow-hidden border-0 bg-white/70 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-purple-600/5 to-blue-800/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400/20 to-purple-600/20 rounded-full blur-3xl -translate-y-8 translate-x-8" />
              ...
              <CardContent className="relative z-10 p-8">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="font-heading text-2xl font-bold mb-3">Изготовление памятников</h4>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      Индивидуальное изготовление из премиальных материалов: гранит, мрамор, бронза
                    </p>
                    
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex items-center gap-2 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span>Гранит премиум</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-2xl font-bold text-blue-600">от 45 000 ₽</div>
                        <div className="text-sm text-muted-foreground">включая установку</div>
                      </div>
            ...
            <Card className="group relative overflow-hidden border-0 bg-white/70 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/5 via-teal-600/5 to-emerald-800/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/20 to-teal-600/20 rounded-full blur-3xl -translate-y-8 translate-x-8" />
              ...
              <CardContent className="relative z-10 p-8">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="font-heading text-2xl font-bold mb-3">Мемориальные комплексы</h4>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      Семейные захоронения, склепы и элитные мемориальные комплексы под ключ
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span>Склепы, усыпальницы</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span>Элитные проекты</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-2xl font-bold text-emerald-600">от 150 000 ₽</div>
                        <div className="text-sm text-muted-foreground">проект под ключ</div>
                      </div>
            ...
            {/* Благоустройство */}
            <Card className="group relative overflow-hidden border-0 bg-white/70 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-600/5 via-orange-600/5 to-amber-800/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-amber-400/20 to-orange-600/20 rounded-full blur-3xl -translate-y-8 translate-x-8" />
              ...
              <CardContent className="relative z-10 p-8">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="font-heading text-2xl font-bold mb-3">Благоустройство участка</h4>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      Комплексное обустройство мемориального участка: облицовка, цветники, дорожки
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-2xl font-bold text-amber-600">от 25 000 ₽</div>
                        <div className="text-sm text-muted-foreground">за комплект работ</div>
                      </div>
            ...
            <Card className="group relative overflow-hidden border-0 bg-white/70 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600/5 via-indigo-600/5 to-purple-800/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-400/20 to-indigo-600/20 rounded-full blur-3xl -translate-y-8 translate-x-8" />
              ...
              <CardContent className="relative z-10 p-8">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="font-heading text-2xl font-bold mb-3">Художественное оформление</h4>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      Гравировка портретов, художественная резьба, золочение и декоративные элементы
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-2xl font-bold text-purple-600">от 15 000 ₽</div>
                        <div className="text-sm text-muted-foreground">за элемент</div>
                      </div>
                      <Button className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white px-6">
          ...
          {/* Bottom CTA */}
          <div className="text-center">
            <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-white/50">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-lg mb-2">Бесплатная консультация</h4>
                  <p className="text-muted-foreground text-sm">Поможем выбрать оптимальное решение</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-lg mb-2">3D-макет бесплатно</h4>
                  <p className="text-muted-foreground text-sm">При заказе любого памятника</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-lg mb-2">Быстрые сроки</h4>
                  <p className="text-muted-foreground text-sm">Изготовление за 14-21 день</p>
                </div>
              </div>
              
              <div className="mt-8">
                <Button size="lg" className="bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-700 text-white px-12 py-4 text-lg">
