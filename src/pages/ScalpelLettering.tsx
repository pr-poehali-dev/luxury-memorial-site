    ...
    <Layout>
      <div className="bg-background">
          ...
          <div className="container mx-auto max-w-7xl px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-green-700">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-green-700">Преимущества рубленых букв</h2>
        ...
        <section id="services" className="py-16 px-4 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-green-700">Виды услуг и цены</h2>
              <p className="text-muted-foreground">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-green-700">Процесс изготовления</h2>
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-green-700">Примеры работ</h2>
              <p className="text-muted-foreground">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold mb-6 text-green-700">Заказать рубленые буквы</h2>
