            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="bg-muted/50 backdrop-blur-sm rounded-lg px-6 py-3 border">
                  <div className="text-2xl font-bold text-primary">{featuredCities.length}</div>
                  <div className="text-sm text-muted-foreground">городов области</div>
                </div>
                <div className="bg-muted/50 backdrop-blur-sm rounded-lg px-6 py-3 border">
              ...
              {featuredCities.map((city) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-semibold text-foreground group-hover:text-primary transition-colors font-heading">
                        {city.name}
                      </h3>
