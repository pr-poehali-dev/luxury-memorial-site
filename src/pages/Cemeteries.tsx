...
const moscowCemeteries: Cemetery[] = [
  ...
  },
  {
    ...
    type: 'moscow',
    district: 'СВАО',
    description: 'Современное кладбище с хорошим транспортным сообщением и ухоженной территорией.',
    established: '1989',
    area: '35 га',
    address: 'д. Бусиново, Красногорский район, Московская область'
  },
  {
    ...
    type: 'moscow',
    district: 'ЦАО',
    description: 'Историческое кладбище в центре Москвы, место упокоения многих известных деятелей культуры и искусства.',
    established: '1771',
    area: '51 га',
    address: 'Сергея Макеева ул., 15, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'ЮЗАО',
    description: 'Одно из старейших и крупнейших кладбищ Москвы с богатым культурно-историческим наследием.',
    established: '1771',
    area: '60 га',
    address: 'ул. Наметкина, 2А, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'ВАО',
    description: 'Современное благоустроенное кладбище в Восточном округе с удобной транспортной доступностью.',
    established: '1974',
    area: '48 га',
    address: 'ул. Молдагуловой, 20А, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'СВАО',
    description: 'Современное кладбище в районе Владыкино с развитой инфраструктурой и зелеными насаждениями.',
    established: '1968',
    area: '41 га',
    address: 'ул. Ботаническая, 29, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'ЮАО',
    description: 'Крупное современное кладбище в Южном округе, известное своими мемориальными комплексами.',
    established: '1962',
    area: '97 га',
    address: 'ул. Востряковская, 15А, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'САО',
    description: 'Благоустроенное кладбище в Северном округе с удобными подъездными путями.',
    established: '1951',
    area: '33 га',
    address: 'ул. Флотская, 85А, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'ВАО',
    description: 'Современное кладбище в районе Гольяново с развитой парковой зоной и мемориальными участками.',
    established: '1977',
    area: '39 га',
    address: 'Амурская ул., 2Б, Москва'
  },
  {
    ...
    type: 'moscow',
    district: 'ЮАО',
    description: 'Историческое кладбище при Даниловом монастыре, одно из древнейших мест упокоения в Москве.',
    established: '1560',
    area: '29 га',
